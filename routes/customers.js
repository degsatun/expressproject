...
var authentication_mdl = require('../middlewares/authentication');	//alway check everytime when refresh page
var session_store;
/* GET Customer page. */
...
router.get('/',authentication_mdl.is_login, function(req, res, next) {
	req.getConnection(function(err,connection){
		var query = connection.query('SELECT * FROM customer',function(err,rows)
		{
			...
			res.render('customer/list',{title:"Customers", data:rows, session_store:req.session, email:email});
		});
